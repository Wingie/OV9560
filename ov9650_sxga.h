struct ov9650_reg ov9650_sxga[] = {
  ...
  {REG_COM5,0x20}, /*  System clock options  */
  ...
  {REG_COM3,0x00}, /*  Output byte swap, signals reassign  */
  {REG_COM4,0x00}, /*  Vario Pixels   */
	
  {REG_CLKRC,0x80}, /*  Clocl control  */
	
  {REG_COM7,0x00}, /*  SCCB reset, output format  */
...
//   {REG_VSTOP,0x81}, /*  Vert stop high bits  */
//   {REG_VSTART,0x01}, /*  Vert start high bits  */
  {REG_HSTART,0x1d}, /*  Horiz start high bits  */
  {REG_HSTOP,0xbd}, /*  Horiz stop high bits  */
  {REG_HREF,0xbf}, /*  HREF pieces  */
